...
const SearchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-28 pb-20 relative overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-indigo-500/8 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-indigo-400 transition-colors group"
          >
            <ArrowLeft
              size={18}
        ...
        <div className="text-center mb-14">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-indigo-400 text-sm font-medium mb-6"
          >
            <Film size={14} />
            Wedding Film Search
          </motion.div>
          ...
          >
            Enter your name and your partner's name to find your wedding
            playlist from our YouTube channel.
          </motion.p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0a0a]/60 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30 transition-all mt-2"
                    value={name1}
                ...
                <div className="relative">
                  ...
                  <input
                    type="date"
                    className="w-full bg-[#0a0a0a]/60 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30 transition-all [color-scheme:dark] mt-2"
                    value={weddingDate}
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                {(name1 || name2 || weddingDate) && (
                  <button
                    type="button"
                    onClick={handleClear}
                    className="inline-flex items-center justify-center px-6 py-3.5 text-base font-medium text-gray-400 border border-white/10 rounded-xl hover:text-white hover:border-white/30 transition-all duration-300 cursor-pointer"
                  >
                    Clear All
                  </button>
                )}
          ...
          {results.map((playlist, pIndex) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between bg-[#111]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-5 md:p-6 hover:border-indigo-500/30 transition-all duration-300 group cursor-pointer"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      ...
                      {playlist.videoCount !== 1 ? "s" : ""} • Uploaded{" "}
        ...
        {results.length === 0 && searched && !loading && (
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              We couldn't find a playlist matching those names. Please check the
              spelling or contact us.
            </p>
          </motion.div>
        )}
        ...
        {!searched && (
          ...
          >
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-white/5 flex items-center justify-center">
              <Heart className="text-indigo-500/40" size={36} />
            </div>
            <p className="text-gray-500 text-lg">
              Enter your details above to discover your wedding films
            </p>
          </motion.div>
        )}
      </div>
